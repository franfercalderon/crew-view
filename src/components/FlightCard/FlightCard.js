...
export default function FlightCard ({day}){
    ...
    //CONTEXT
    const {addZero,capitalizeWords, currentRoster} = useContext(AppContext)
    ...
    const handleSwap = (day) =>{
        ...
        const flightDays = currentRoster.activity.filter(day=>day.flightActivity)
    ...
    return(
        ...
        <div className="flight-card-main-container row">
            ...
            <div className="col-2 d-flex justify-content-center align-items-center">
                {day.active && day.flightActivity && day.departure.fromHub &&
